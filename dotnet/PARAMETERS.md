...
| --- | --- | --- | --- | --- | --- |
| `BEYONDTRUST_ENABLED` | No | Both | `true` | Enables or disables the provider. Invalid boolean values are errors. | `true` |
...
- Shared boolean parameters use the same success/error/default semantics in `.NET` and `Java`.
