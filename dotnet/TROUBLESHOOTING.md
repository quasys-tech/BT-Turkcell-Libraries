...
- `builder.Configuration.AddBeyondTrustSecrets();` çağrısı bir configuration provider ekler.
- Yüklenen değerler ayrı bir API yerine normal `IConfiguration` key'leri üzerinden okunur.
